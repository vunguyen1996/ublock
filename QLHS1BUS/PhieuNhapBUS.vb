...
Public Class PhieuNhapBUS
    ...
    Public Function selectAll_ByNgayNhap(ngaynhap As DateTime, ByRef listPhieu As List(Of PhieuNhapDTO)) As Result
        '1. verify data here!!

        '2. insert to DB
        Return pnDAL.selectALL_ByNgayNhap(ngaynhap, listPhieu)
    End Function

    Public Function selectAll_ByMaPhieuNhap(maPhieu As Integer, ByRef listPhieu As List(Of PhieuNhapDTO)) As Result
        '1. verify data here!!

        '2. insert to DB
        Return pnDAL.selectALL_ByMaPhieuNhap(maPhieu, listPhieu)
    End Function
End Class
